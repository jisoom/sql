...
CREATE TABLE "AB_QNA" (
	...
	"MANAGER_ID"      VARCHAR2(100)  NULL,     -- 관리자아이디
...
CREATE TABLE "AB_ORDER" (
	"ORDER_NO"   NUMBER        NOT NULL, -- 주문번호
	"MEM_ID2"    VARCHAR2(100) NOT NULL, --  회원아이디
...
-- 관리자
CREATE TABLE "AB_MANAGER" (
	"MANAGER_ID"   VARCHAR2(100) NOT NULL, -- 관리자아이디
	"MANAGER_PW"   VARCHAR2(200) NOT NULL, -- 관리자비밀번호
	"MANAGER_NAME" VARCHAR2(200) NOT NULL  -- 관리자이름
);

-- 관리자 기본키
CREATE UNIQUE INDEX "PK_AB_MANAGER"
	ON "AB_MANAGER" ( -- 관리자
		"MANAGER_ID" ASC -- 관리자아이디
	);

-- 관리자
ALTER TABLE "AB_MANAGER"
	ADD
		CONSTRAINT "PK_AB_MANAGER" -- 관리자 기본키
		PRIMARY KEY (
			"MANAGER_ID" -- 관리자아이디
		);

-- 후기
CREATE TABLE "AB_ REVIEW" (
	"MEM_ID"          VARCHAR2(100)  NOT NULL, --  회원아이디
...
-- 후기 기본키
CREATE UNIQUE INDEX "PK_AB_ REVIEW"
	ON "AB_ REVIEW" ( -- 후기
		"MEM_ID" ASC --  회원아이디
	);

-- 후기
ALTER TABLE "AB_ REVIEW"
	ADD
		CONSTRAINT "PK_AB_ REVIEW" -- 후기 기본키
		PRIMARY KEY (
			"MEM_ID" --  회원아이디
		);
...
ALTER TABLE "AB_QNA"
	ADD
		CONSTRAINT "FK_AB_MANAGER_TO_AB_QNA" -- 관리자 -> 1:1문의
		FOREIGN KEY (
			"MANAGER_ID" -- 관리자아이디
		)
		REFERENCES "AB_MANAGER" ( -- 관리자
			"MANAGER_ID" -- 관리자아이디
		);
...
ALTER TABLE "AB_ REVIEW"
	ADD
		CONSTRAINT "FK_AB_MEMBER_TO_AB_ REVIEW" -- 회원 -> 후기
		FOREIGN KEY (
			"MEM_ID" --  회원아이디
		)
		REFERENCES "AB_MEMBER" ( -- 회원
...
ALTER TABLE "AB_NOTICE"
	ADD
		CONSTRAINT "FK_AB_MANAGER_TO_AB_NOTICE" -- 관리자 -> 공지사항
		FOREIGN KEY (
			"MANAGER_ID" -- 관리자아이디
		)
		REFERENCES "AB_MANAGER" ( -- 관리자
        ...
        ALTER TABLE AB_ORDER
        RENAME COLUMN MEM_ID2 TO MEM_ID
