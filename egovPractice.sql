CREATE TABLE SAMPLE(ID VARCHAR2(60) NOT NULL PRIMARY KEY,NAME VARCHAR2(200)
,DESCRIPTION VARCHAR2(1000),USE_YN CHAR(1),REG_USER VARCHAR2(30));

CREATE TABLE IDS(TABLE_NAME VARCHAR(60) NOT NULL PRIMARY KEY,NEXT_ID NUMBER NOT NULL);
